...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> Percel Mail Transfer</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"> Percel Mail Tranfer</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <h5 class="card-title mb-0">PERCEL MAIL TRANSFER LIST IN  {{ $bra->name }} BRANCH</h5>
                ...
                <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            @endforeach
                            <form method="post" action="{{ route('admin.outtp.store') }}">
