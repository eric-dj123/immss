...
@section('page-name')Percel Mail Outboxing History @endsection
@section('body')
@php
$date = "{}";
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Percel Mail Outboxing History</h4>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Percel outboxing History | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    ...
                    <tbody>
                        @php
                            $outboxings = App\Models\registoutboxing::byrange($start, $end);
                            $tot = 0;
                        @endphp
