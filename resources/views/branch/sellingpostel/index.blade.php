...
@section('page-name')Selling Carte Postel @endsection
@section('body')
                ...
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="sort" data-sort="saddress">ADDRESS</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="reg_date">{{ $outbox->created_at }}</td>
                            <td class="snames">{{ $outbox->snames }}</td>
                            <td class="saddress">{{ $outbox->saddress }}</td>
                            <td class="qty">{{ $outbox->qty }}</td>
                            <td class="amount">{{ $outbox->amount }}</td>
                            <td class="action">

                                @can('make outboxing')
                                <a type="button" href="{{ route('branch.sellingpostel.modify',$outbox->out_id) }}"
                                    class="btn btn-success btn-sm"><span>Edit</span></a>
                                @endcan
                                @can('make outboxing')
                                <a href="#deleteRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('branch.sellingpostel.destroy',$outbox->out_id) }}"
    ...
    <div class="modal-dialog  modal-xl">
        <div class="modal-content">
            ...
            <form class="tablelist-form" method="post"
                action="{{ route('branch.sellingpostel.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <center><h4 class="modal-title" id="standard-modalLabel">CUSTOMER INFORMATION</h4></center>
                          ...
                          <div class="col-12">
                            ...
                            <div class="mb-3">
                              ...
                              <input name="snames"  type="text" class="form-control" id="validationCustom01"  autocomplete="off" >
                       ...
                       <div class="col-4">
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input name="qty" type="text" class="form-control" id="qty"  required  autocomplete="off" oninput="walk_on();">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" name="postage" id="prrice" required autocomplete="off"  oninput="walk_on();">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" name="amount" id="tot" required autocomplete="off" readonly>
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
