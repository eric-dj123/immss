        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">EMS outboxing Edit</h5>
                        </div>
                    </div>
            ...
            action="{{ route('branch.outboxing.update',$outbox->out_id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <center>
                            <h4 class="modal-title" id="standard-modalLabel">SENDER INFORMATION </h4>
                        </center>
                          ...
                          <div class="col-12">
                            ...
                            <div class="mb-3">
                              ...
                              <input name="tracking"  type="text" class="form-control" id="validationCustom01"  autocomplete="off" value="{{ $outbox->tracking }}">
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input required  name="snames" type="text" class="form-control" id="validationCustom01"   autocomplete="off" value="{{ $outbox->snames }}">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input  name="sphone"  required type="text" class="form-control" id="validationCustom01"   autocomplete="off" value="{{ $outbox->sphone }}">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                            <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input  name="semail"  type="email" class="form-control" id="validationCustom01"    autocomplete="off" value="{{ $outbox->semail }}">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input name="snid" type="text" class="form-control" id="validationCustom01" required value="{{ $outbox->snid }}" autocomplete="off">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                        ...
                        <div class="col-4">
                            <div class="mb-3">
                              <label class="form-label" for="validationCustom01">NAMES</label>
                              <input required  name="rnames" type="text" class="form-control" id="validationCustom01" value="{{ $outbox->rnames }}" required autocomplete="off">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          <div class="col-4">
                            ...
                            <div class="mb-3">
                              ...
                              <input  name="raddress"  type="text" class="form-control" value="{{ $outbox->raddress }}" id="validationCustom01" required   autocomplete="off">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                       ...
                       <label class="form-label" for="validationCustom01"><b>POSTING INFORMATION </b></label>
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" id="weight" name="weight" value="{{ $outbox->weight }}" required autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" id="amount" name="amount" value="{{ $outbox->amount }}" required autocomplete="off">
                          ...
                          <div class="col-4">
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" name="postage" value="{{ $outbox->postage }}" id="prrice" required autocomplete="off">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                          <div class="col-12">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="total_amount_full"readonly value="{{ $outbox->amount+$outbox->postage }}">
                              <div class="valid-feedback"> ok </div>
                            </div>
                          </div>
                            <div class="col-6">
