                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form class="tablelist-form" method="post"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="tin-field" class="form-label">Category Description</label>
                                                    <input type="text" id="tin-field" class="form-control"
                                                        name="categorydescription" placeholder="Enter Description" required
                                                        value="{{ old('categorydescription') }}" />
                                                    <div class="invalid-feedback">
                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="name"><a
                                    href="{{ route('admin.category.profile',$category->id) }}">{{ $category->categoryname }}</a>
                            </td>
                            ...
                            <td>
                                ...
                                @can('delete category')
                                <a href="#deleteRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('admin.category.destroy',$category->id) }}"
                ...
                <form method="post" id="categoryupdate" action="#">
                    ...
                    <div class="mb-3">
                        <label for="edit-category-field" class="form-label">Category
                            Name</label>
                        <input type="text" id="edit-category-field" name="editcategoryname"
                            class="form-control" placeholder="Enter Category name"
                            value="{{ old('editcategoryname') }}" required />
                        <div class="invalid-feedback">
                            Please enter a category name.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="edit-cat-desc" class="form-control"
                            name="editcategorydescription" placeholder="Enter Description" required
                            value="{{ old('editcategorydescription') }}" />
                        <div class="invalid-feedback">
