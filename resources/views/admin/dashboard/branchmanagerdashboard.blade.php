                 ...
                 <div class="d-flex align-items-end justify-content-between mt-4">
                     <div>
                         <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                 data-target="{{ $incomebranch }}">{{ $incomebranch }}</span> RWF</h4>
                         <a href="{{ route('branch.breporting.profit') }}" class="text-decoration-underline">View
                             Income</a>
                     </div>
         ...
         <div class="card card-animate">
             <div class="card-body">
                 ...
                 <div class="d-flex align-items-end justify-content-between mt-4">
                     <div>
                         <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                 data-target="{{ $expensesbranch }}">{{ $expensesbranch }}</span> RWF</h4>
                         <a href="{{ route('branch.breporting.profit') }}" class="text-decoration-underline">View
                             Expenses</a>
                     </div>
                     <div class="avatar-sm flex-shrink-0">
         ...
         <div class="card card-animate">
             <div class="card-body">
                 ...
                 <div class="d-flex align-items-end justify-content-between mt-4">
                     <div>
                         <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                 data-target="{{ $balancebranch }}">{{ $balancebranch }}</span> RWF</h4>
                         <a href="{{ route('branch.breporting.profit') }}" class="text-decoration-underline">View
                             Balance</a>
                     </div>
                     <div class="avatar-sm flex-shrink-0">
