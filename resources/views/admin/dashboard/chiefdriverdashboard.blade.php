            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">TOTAL DRIVER</p>
                    </div>
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                data-target="{{ $totaldriver }}">{{ $totaldriver }}</span></h4>
                        <a href="{{ route('driver.index') }}" class="text-decoration-underline">View
                            Driver</a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">TOTAL VEHICLE</p>
                    </div>
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                data-target="{{ $totalvehicle }}">{{ $totalvehicle }}</span></h4>
                        <a href="{{ route('admin.vehicle.Vehicles') }}" class="text-decoration-underline">View
                            Vehicle</a>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">ASSIGNED DRIVER</p>
                    </div>
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                data-target="{{ $totalassigned }}">{{ $totalassigned }}</span></h4>
                        <a href="{{ route('driver.withVehicle') }}" class="text-decoration-underline">View
                            Assigned</a>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card card-animate">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">UNASSIGNED DRIVER</p>
                    </div>
                ...
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                data-target="{{ $totalunassigned }}">{{ $totalunassigned }}</span></h4>
                        <a href="{{ route('driver.withoutVehicle') }}" class="text-decoration-underline">View
                        Unassigned</a>
                    </div>
                    <div class="avatar-sm flex-shrink-0">
                        <span class="avatar-title bg-soft-info rounded fs-2">
