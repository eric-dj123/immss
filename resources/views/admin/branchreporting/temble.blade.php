...
@section('page-name')Posting With Temble outboxing Report @endsection
@section('body')
@php
$date = "{}";
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Posting With Temble outboxing Report</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Posting With Temble outboxing Report</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Posting With Temble outboxing Report  | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
                ...
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="sort" data-sort="temble">Temble Amount</th>
                    ...
                    <tbody>
                        @php
                            $outboxings = App\Models\tembleoutboxing::ems_report($start, $end);
                            $tot = 0;
                        @endphp
                        ...
                        <tr>
                            ...
                            <td class="receiver">{{ $outbox->temb_amount }}</td>

                            <td class="tax">{{ $outbox->postage }}</td>
                            <td class="carton">{{ $outbox->total }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
...
<style type="text/css">
    ...
    "drawCallback": function(settings) {
        ...
        var tembData = api.column(4, { search: 'applied' }).data();
        var cartonData = api.column(5, { search: 'applied' }).data();
