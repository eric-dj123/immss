...
@section('page-name')Percel Outboxing Income Report @endsection
@section('body')
@php
$date = "{}";
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Percel Outboxing Income Report</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Percel Outboxing Income Report</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Percel Outboxing Income Report  | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
            ...
            <div class="card-body">
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    ...
                    <tbody>
                        @php
                            $outboxings = App\Models\registoutboxing::ems_report($start, $end);
                            $tot = 0;
                        @endphp
...
<style type="text/css">
    ...
    "drawCallback": function(settings) {
        ...
        var taxData = api.column(4, { search: 'applied' }).data();
