        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">ACTIVITY REPORT FOR AGENCIES</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                  ...
                                  $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `outboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                  ...
                                  unset($res);
                                  unset($row);
                                  $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `poutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                  ...
                                  unset($res);
                                  unset($row);
                                    $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `registoutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                  ...
                                  $res = DB::select($sql);
                                    ...
                                    foreach ($res as $row) {
                                      ...
                                      unset($res);
                                      unset($row);
                                    $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.temb_amount,0)) AS amount, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `tembleoutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    $sql = "SELECT MAX(a.name), SUM(IFNULL(b.weight, 0)) AS weight, SUM(IFNULL(b.temb_amount, 0)) AS amount, SUM(IFNULL(b.postage, 0)) AS postage
                                    FROM branches a
