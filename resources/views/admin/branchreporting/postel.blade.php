...
@section('page-name')Carte Postel Selling Report @endsection
@section('body')
@php
$date = "{}";
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Carte Postel Selling Report</h4>
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Carte Postel Selling Report</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Carte Postel Selling Report  | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
                ...
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="sort" data-sort="weight">Total Quantity</th>
                            <th class="sort" data-sort="total">Total</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
                            $outboxings = App\Models\posteloutboxing::ems_report($start, $end);
                            $tot = 0;
                        @endphp
...
<style type="text/css">
    ...
    "drawCallback": function(settings) {
        ...
        // get the column data
        var totalData = api.column(3, { search: 'applied' }).data();
