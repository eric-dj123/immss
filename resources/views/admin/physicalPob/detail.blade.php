                                            ...
                                            <form class="tablelist-form" method="post"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="EMSNationalContract"
                                                                class="form-label">HAS EMS NATIONAL CONTRACT</label>
                                                                <select class="form-select" name="EMSNationalContract" required
                                                                aria-label="Default select example">
                                                                <option value="yes"
                                                                    {{ $box->EMSNationalContract == 'yes' ? 'selected' : '' }}>YES
                                                                </option>
                                                                <option value="no"
                                                                    {{ $box->EMSNationalContract == 'no' ? 'selected' : '' }}>NO
                                                                </option>
                                                            </select>
                                                        </div>
