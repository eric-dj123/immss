                            ...
                            <tbody>
                                @foreach ($countries as $key =>$country)
                                    <tr>
                                        ...
                                        <td class="name"><a href="">{{ $country->countries }}</a>
                                        </td>


                                        <td>
                                            <a href="#showModals{{ $country->pc_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-primary btn-sm"><span>Edit</span></a>
                                            <div class="modal fade" id="showModals{{ $country->pc_id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post"
                                                            action="{{ route('admin.percecountreg.update', $country->pc_id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="countryname-field"
                                                                        class="form-label">Country Name
                                                                    </label>
                                                                    <input type="text" id="countryname-field"
                                                                        name="countries" class="form-control"
                                                                        placeholder="Enter countryname"
                                                                        value="{{ $country->countries }} {{ old('countries') }}"
                                                                        required />
                                            ...
                                            <a href="#deleteRecordModal{{ $country->pc_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-danger btn-sm"><span>Delete</span></a>

                                                <div class="modal fade" id="deleteRecordModal{{ $country->pc_id }}" tabindex="-1"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-light p-3">
                                                            ...
                                                            <form class="tablelist-form" id="myForm" method="post"
                                                                action="{{ route('admin.percecountreg.destroy',$country->pc_id) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="tablelist-form" method="post" action="{{ route('admin.percecountreg.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            @if ($errors->any())
