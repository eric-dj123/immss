    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0"> Customer Registration</h4>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                                <div>
                                    <h5 class="card-title mb-0">Customer Registration List</h5>
                                </div>
                            </div>
                        ...
                        <table id="datatableAjax" class="table table-centered table-hover align-middle table-nowrap mb-0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort" data-sort="phone">Company Name</th>
                                    <th class="sort" data-sort="action">Tin Number</th>
                                    <th class="sort" data-sort="phone">PhoneNumber</th>
                            ...
                            <tbody>
                                @foreach ($customers as $key =>$customer)
                                    <tr>
                                        ...
                                        <td class="name"><a href="">{{ $customer->tokennumber }}</a>
                                        </td>
                                        <td class="email">{{ $customer->namecompany }}</td>
                                        <td class="name"><a href="">{{ $customer->tin }}</a>
                                        </td>
                                        <td class="email">{{ $customer->phone }}</td>


                                        <td>
                                            <a href="#showModals{{ $customer->token_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-primary btn-sm"><span>Edit</span></a>
                                            <div class="modal fade" id="showModals{{ $customer->token_id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post"
                                                            action="{{ route('admin.cust.update', $customer->token_id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="customername-field"
                                                                        class="form-label">	namecompany
                                                                    </label>
                                                                    <input type="text" id="customername-field"
                                                                        name="namecompany" class="form-control"
                                                                        placeholder="Enter namecompany"
                                                                        value="{{ $customer->namecompany }}  {{ old('namecompany') }}"
                                                                        required />
    ...
    <div class="modal fade zoomIn" id="deleteRecordModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.cust.destroy',$customer->token_id) }}">
                        @csrf
                        @method('DELETE')
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="tablelist-form" method="post" action="{{ route('admin.cust.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            @if ($errors->any())
