                ...
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        @foreach ($zones as $key =>$zone)
                                <div>
                                    <h5 class="card-title mb-0">TARRIF REGISTRATION IN {{ $zone->zonename }}</h5>
                                </div>
                                @endforeach
                            </div>
                            ...
                            <tbody>
                                @foreach ($sets as $key =>$set)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#showModals{{ $set->tarif_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-primary btn-sm"><span>Edit</span></a>
                                            <div class="modal fade" id="showModals{{ $set->tarif_id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post"
                                                            action="{{ route('admin.czone.storetarifup', $set->tarif_id) }}">
                                                            @csrf
                                                            @method('PUT')
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="tablelist-form" method="post" action="{{ route('admin.czone.storetarif') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            @if ($errors->any())
                        ...
                        <input type="hidden" name="zone_id" id=""value="{{ $zone_id }}">
