                            ...
                            <tbody>
                                @foreach ($countries as $key =>$country)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#showModals{{ $country->c_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-primary btn-sm"><span>Edit</span></a>
                                            <div class="modal fade" id="showModals{{ $country->c_id }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post"
                                                            action="{{ route('admin.countri.update', $country->c_id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" id="countryname-field"
                                                                        ...
                                                                        value="{{ $country->countryname }} {{ old('countryname') }}"
                                                                        required />
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="countryname-field"
                                                                        class="form-label">Country Number
                                                                    </label>
                                                                    <input type="text" id="countryname-field"
                                            ...
                                            <a href="#deleteRecordModal{{ $country->c_id }}" data-bs-toggle="modal"
                                                type="button" class="btn btn-danger btn-sm"><span>Delete</span></a>

                                                <div class="modal fade" id="deleteRecordModal{{ $country->c_id }}" tabindex="-1"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-light p-3">
                                                            ...
                                                            <form class="tablelist-form" id="myForm" method="post"
                                                                action="{{ route('admin.countri.destroy',$country->c_id) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="modal-body">
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="tablelist-form" method="post" action="{{ route('admin.countri.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            @if ($errors->any())
