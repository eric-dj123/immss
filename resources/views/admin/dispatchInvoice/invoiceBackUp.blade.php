...
@section('page-name')Invoice of Mails  @endsection
@section('body')
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless text-center table-nowrap align-middle mb-0">
                                ...
                                <tbody id="products-list">
                                    ...
                                    <td class="text-start">{{ $mail->weight }}</td>
                                    <td class="text-start">{{ $mail->price }}</td>
                                    <td class="text-start">{{ number_format($mail->total_amount) }}</td>
                                    </tr>
                                    @endforeach
