...
<body>
    ...
    <div class="watermark">DISPATCH OPENED REPORT {{ date('M', mktime(0, 0, 0, $date, 1)) }}</div>
 <table width="100%">
<tr>
<td  width="25%">
...
<h1 style="text-align:center">DISPATCH OPENED  REPORT ON {{ date('M', mktime(0, 0, 0, $date, 1)) }} </h1>
