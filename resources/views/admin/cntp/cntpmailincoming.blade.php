...
@section('page-name')Dispatch Receive @endsection
@section('body')
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            ...
                            <a class="btn btn-soft-primary" style="display: none;" id="deleteBtn"  href="#deleteRecordModal" data-bs-toggle="modal">
                                Approve Receiving
                            </a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                ...
                                <button type="submit" class="btn w-sm btn-primary" id="delete-record">
                                    Yes, Approve It!
                                </button>
                            </div>
                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="dispatchid[]" value="{{ $inboxing->id }}">
                                </div>
                            </td>
                            <td scope="row">
                                {{ $key + 1 }}
        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('admin.inbox.store') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="customername-field" name="dispatchNumber"
                            ...
                            value="{{ old('orgincountry') }}" required />
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="customername-field" name="currentweight"
                            class="form-control" placeholder="Current Weight"
                            value="{{ old('currentweighty') }}" />
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="VertimeassageInput" name="comment" rows="3" placeholder="Enter your comment"></textarea>
