                        ...
                        <table class="table table-bordered " id="my-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        Number Of Ordinary Package
                                    </th>
                                    <th>
                                        Number Of Ordinary Letter
                                    </th>
                                    <th>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control quantity-input p_qty " name="quantitythree[]"
                                  >
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-secondary quantity-plus-btn">+</button>
                                </div>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control quantity-input p_qty " name="quantityfour[]"
                                  >
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-secondary quantity-plus-btn">+</button>
                                </div>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control quantity-input p_qty " name="quantityfive[]"
                                  >
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-secondary quantity-plus-btn">+</button>
                                </div>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control quantity-input p_qty " name="quantitysix[]"
                                  >
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-secondary quantity-plus-btn">+</button>
                                </div>
