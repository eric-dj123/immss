        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Mail Transfer</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <div>
                            <h5 class="card-title mb-0">REGISTERED LETTER TRANSFER</h5>
                        </div>
                    </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <a href="{{ route('admin.transferrl.RegisteredLetterTransfers', ['id' => encrypt($branch->id)]) }}"><p class="text-uppercase fw-semibold fs-12 text-muted mb-1">{{ $branch->name }}</p></a>
                                            </div>
