            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <div>
                            <h5 class="card-title mb-0">POSTAL CARD MAIL TRANSFER</h5>
                        </div>
                    </div>
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                ...
                                                <a href="{{ route('admin.transferpostcard.PostCardTransfers',['id' => encrypt($branch->id)]) }}"><p class="text-uppercase fw-semibold fs-12 text-muted mb-1">{{ $branch->name }}</p></a>
                                            </div>
