...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> ORDINARY LETTER Transfer</h4>
            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <form method="post" action="{{ route('admin.transferol.storeletterod') }}">
                            @endforeach
                            @csrf

                        <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#myModal">OL Transfer By Number</button>
                        <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myModalLabel">ORDINARY LETTER TRANSFER BY NUMBER IN {{ $bra->name }} BRANCH</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        NUMBER OF ORDINARY LETTER</label>
                                        <div class="mb-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            ...
                            <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i>OL Transfer
                            </button>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light p-3">
                                <h5 class="modal-title" id="exampleModalLabel"> ORDINARY LETTER TRANSFER IN {{ $bra->name }} BRANCH </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                    id="close-modal"></button>
                            </div>

                            <form method="post" action="{{ route('admin.transferol.store') }}">
...
<script>
    $(document).ready(function () {
        $('#datatableAjax').DataTable({
            ...
            processing: true,
            scrollX: true,
            ajax: "{{ route('OrdinaryLetterApi.ordletterapi', ['id' => $id,'user' => auth()->user()->id]) }}",
            columns: [
                { data: 'idd'},
                { data: 'user_name' },
                { data: 'branch_name'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        var idd = row.idd;
                        var route = "{{ route('admin.transferol.invoiceod', ['idd' => ':idd']) }}";
