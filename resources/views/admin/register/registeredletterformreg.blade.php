...
@section('page-name')Letter Registration @endsection
@section('css')
                ...
                <div class="card-header border-bottom-dashed">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm">
                            <div>
                                @foreach ($bras as $key => $bra)
                                <h5 class="card-title mb-0">REGISTERED LETTER REGISTRATION LIST IN {{ $bra->name }}</h5>
                                @endforeach
                            </div>
                        </div>
                                            ...
                                            <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post" action="{{ route('admin.mailsrl.update',$inboxing->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-control" data-choices
                                                                    ...
                                                                    <option
                                                                        @if ($inboxing->comment == 'Item recieved') selected @endif
                                                                        value="Item recieved">Item recieved</option>
                                                                    <option
                                                                        @if ($inboxing->comment == 'Item recieved torn and Repaired at the CNTP') selected @endif
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="customername-field" name="intracking"
                                                ...
                                                value="{{ old('intracking') }}" autocomplete="off" />
                                            <div class="invalid-feedback">
                                                Please enter a Tracting Number .
                                            </div>
                                        </div>
