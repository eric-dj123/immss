...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> @foreach ($bras as $key => $bra)
              PERCEL MAIL TRANSFER LIST IN  {{ $bra->name }} BRANCH </h4>
            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#myModal">Percel Transfer By Number</button>
                        <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myModalLabel">PERCEL TRANSFER BY NUMBER IN {{ $bra->name }} BRANCH</h5>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light p-3">
                                <h5 class="modal-title" id="exampleModalLabel"> PERCEL MAIL TRANSFER IN {{ $bra->name }} BRANCH </h5>
        ...
        $('#datatableAjax').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        var idd = row.idd;
                        var route = "{{ route('admin.transferp.invoicereg', ['idd' => ':idd']) }}";
