                                            ...
                                            <div class="modal fade" id="showModal{{ $inboxing->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form class="tablelist-form" id="myForm" method="post" action="{{ route('admin.mailsem.update',$inboxing->id) }}">
                                                            @csrf
                                                            @method('PUT')
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <input type="text" name="phone" class="form-control phoneNumber"
                                                                            placeholder="Enter phone no." maxlength="10" minlength="10" value=" {{ $inboxing->phone }} {{ old('phone') }}" required autocomplete="off"/>
                                                                        <div class="invalid-feedback">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" name="phone" class="form-control phoneNumber"
                                                    placeholder="Enter phone no." required maxlength="10" minlength="10" value="{{ old('phone') }}" autocomplete="off"/>
                                                <div class="invalid-feedback">
                                                    Please enter a phone.
                                                </div>
                                            </div>
