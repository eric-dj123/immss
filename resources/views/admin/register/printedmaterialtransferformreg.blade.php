...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"> PRINTED MATERIAL  PACKAGE Transfer</h4>
            ...
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        ...
                        <form method="post" action="{{ route('admin.transferprinted.printedtranumber') }}">
                            @endforeach
                            @csrf

                        <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#myModal">Printed Package Transfer By Number</button>
                        <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myModalLabel">PRINTED PACKAGE TRANSFER BY NUMBER IN {{ $bra->name }} BRANCH</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        NUMBER OF PRINTED MATERIAL PACKAGE</label>
                                        <div class="mb-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex flex-wrap align-items-start gap-2">
                            ...
                            <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn"
                                ...
                                <i class="ri-add-line align-bottom me-1"></i> PRM Transfer
                            </button>
                ...
                <div>
                        ...
                        <table id="datatableAjax" class="table table-centered table-hover align-middle table-nowrap mb-0"
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.transferprinted.invoiceprinted', encrypt($result->id)) }}" class="btn btn-sm btn-primary" target="_blank">PRINT</a>
                            </td>
                            </tr>
                            @endforeach
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header bg-light p-3">
                                <h5 class="modal-title" id="exampleModalLabel"> PRINTED MATERIAL MAIL TRANSFER IN {{ $bra->name }} BRANCH </h5>
