...
@section('page-name')Income Types @endsection
@section('body')
                                ...
                                <div class="modal-dialog model-lg">
                                    <div class="modal-content">
                                        ...
                                        <form class="tablelist-form" method="post"
                                            action="{{ route('admin.income_types.store') }}" enctype="multipart/form-data">
                                            @csrf
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#deleteRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('admin.income_types.destroy', $income_type->et_id) }}"
