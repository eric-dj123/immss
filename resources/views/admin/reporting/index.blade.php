        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">ACTIVITY REPORT FOR AGENCIES | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
                ...
                <table id="manageBrandTable" class="table nowrap table-bordered align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                  ...
                                  $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.tax,0)) AS tax, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `outboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                  ...
                                  unset($res);
                                  unset($row);
                                  $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.tax,0)) AS tax, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `poutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                  ...
                                  unset($res);
                                  unset($row);
                                    $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.amount,0)) AS amount, SUM(IFNULL(b.tax,0)) AS tax, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `registoutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                    ...
                                    unset($res);
                                    unset($row);
                                    $sql = "SELECT max(a.name),SUM(IFNULL(b.qty,0)) AS weight, SUM(IFNULL(b.amount,0)) AS postage FROM branches a LEFT JOIN `posteloutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                                    ...
                                    foreach ($res as $row) {
                                      ...
                                      unset($res);
                                      unset($row);
                                    $sql = "SELECT max(a.name),SUM(IFNULL(b.weight,0)) AS weight, SUM(IFNULL(b.temb_amount,0)) AS amount, SUM(IFNULL(b.tax,0)) AS tax, SUM(IFNULL(b.postage,0)) AS postage FROM branches a LEFT JOIN `tembleoutboxing` b ON(a.id=b.blanch $v) WHERE a.id = '$bid' AND b.item_id = $item_id GROUP BY a.id";
                                  //echo $sql."<br>";
                                  $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    FROM branches a
                                    LEFT JOIN `outboxing` b ON (a.id = b.blanch $v) WHERE a.id = '$bid'";
                                    $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    $sql = "SELECT MAX(a.name), SUM(IFNULL(b.weight, 0)) AS weight, SUM(IFNULL(b.amount, 0)) AS amount, SUM(IFNULL(b.postage, 0)) AS postage
                                    FROM branches a
                                    LEFT JOIN `registoutboxing` b ON (a.id = b.blanch $v) WHERE a.id = '$bid'";
                                    $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    $sql = "SELECT MAX(a.name), SUM(IFNULL(b.weight, 0)) AS weight, SUM(IFNULL(b.amount, 0)) AS amount, SUM(IFNULL(b.postage, 0)) AS postage
                                    FROM branches a
                                    LEFT JOIN `poutboxing` b ON (a.id = b.blanch $v) WHERE a.id = '$bid'";
                                    $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    $sql = "SELECT MAX(a.name), SUM(IFNULL(b.weight, 0)) AS weight, SUM(IFNULL(b.temb_amount, 0)) AS amount, SUM(IFNULL(b.temb_amount, 0)) AS postage
                                    FROM branches a
                                    LEFT JOIN `tembleoutboxing` b ON (a.id = b.blanch $v) WHERE a.id = '$bid'";
                                    $res = DB::select($sql);
                          ...
                          @php
                          $row_tot = 0;
                          $services = DB::table('pob_pays')
                          ->selectRaw('CONCAT("POB Paid -",MAX(serviceType), "-", MAX(payment_type)) AS service_name, MAX(serviceType) AS serviceType, MAX(payment_type) AS payment_type')
                          ->groupBy('serviceType','payment_type')
                          ->get();
                          @endphp
                          ...
                          @foreach ($branches as $br)
                            ...
                            if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                              ...
                              $carton = 0;
                                  ...
                                  FROM branches a
                                  LEFT JOIN `pob_pays` b ON (a.id = b.bid AND b.serviceType = '".$service->serviceType."' AND b.payment_type = '".$service->payment_type."' $v) WHERE a.id = '$bid'";
                                  $res = DB::select($sql);
                            ...
                            @foreach ($branches as $br)
                              ...
                              if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                                ...
                                $carton = 0;
                                    ...
                                    $sql = "SELECT SUM(IFNULL(b.amount, 0)) AS amount
                                    FROM branches a
                                    LEFT JOIN `courierpays` b ON (a.id = b.bid AND b.extra = 'o' $v) WHERE a.id = '$bid'";
                                    $res = DB::select($sql);
                        ...
                        @foreach ($branches as $br)
                          ...
                          if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                            ...
                            $carton = 0;
                                ...
                                $sql = "SELECT SUM(IFNULL(b.amount, 0)) AS amount
                                FROM branches a
                                LEFT JOIN `courierpays` b ON (a.id = b.bid AND b.extra = 'r' $v) WHERE a.id = '$bid'";
                                $res = DB::select($sql);
                        ...
                        @foreach ($branches as $br)
                          ...
                          if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                            ...
                            $carton = 0;
                                ...
                                $sql = "SELECT SUM(IFNULL(b.amount, 0)) AS amount
                                FROM branches a
                                LEFT JOIN `courierpays` b ON (a.id = b.bid AND b.extra = 'p' $v) WHERE a.id = '$bid'";
                                $res = DB::select($sql);
                        ...
                        @foreach ($branches as $br)
                          ...
                          if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                            ...
                            $carton = 0;
                                ...
                                $sql = "SELECT SUM(IFNULL(b.amount, 0)) AS amount
                                FROM branches a
                                LEFT JOIN `courierpays` b ON (a.id = b.bid AND b.extra = 'ems' $v) WHERE a.id = '$bid'";
                                $res = DB::select($sql);
                          ...
                          @foreach ($branches as $br)
                            ...
                            if (isset($start) && !empty($start) && isset($end) && !empty($end)) {
                              ...
                              $carton = 0;
                                  ...
                                  FROM branches a
                                  LEFT JOIN `income` b ON (a.id = b.branch_id AND b.et_id = '".$income->et_id."' AND b.e_status=1 $v) WHERE a.id = '$bid'";
                                  $res = DB::select($sql);
