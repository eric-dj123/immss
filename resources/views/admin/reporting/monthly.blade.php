...
@section('page-name')ACTIVITY REPORT FOR AGENCIES | From : {{ $start_month }} , To : {{ $end_month }} @endsection
@section('body')
@php
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">ACTIVITY REPORT FOR AGENCIES | From : {{ $start_month }} , To : {{ $end_month }}</h5>
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        @while ($month <= $mx_y)
                            <tr>
                                ...
                                @endphp
                                <td>
                                    <a type="button" class="btn btn-primary btn-sm edit-item" href="{{ route('admin.reporting.index',$link) }}"
                                        ><span>View Detailed</span></a>
                                </td>
                            </tr>
                            @php
                                // $currentDate->modify('+1 day');
