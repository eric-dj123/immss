...
@section('page-name')Rejected Income @endsection
@section('body')
@php
$date = "{}";
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Rejected Income</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Rejected Income Report | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
