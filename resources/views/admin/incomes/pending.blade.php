...
@section('page-name')Pending Income @endsection
@section('body')
@php
$date = "{}";
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Pending Income</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header border-bottom-dashed">
                <div class="row g-4 align-items-center">
                    <div class="col-sm">
                        <div>
                            <h5 class="card-title mb-0">Pending Income Report | From : {{ $start }} , To : {{ $end }}</h5>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a type="button" class="btn btn-primary btn-sm edit-item"
                                        ...
                                        data-e_name="{{ $income->e_name }}"
                                        data-e_description="{{ $income->e_description }}"
                                        data-e_amount="{{ $income->e_amount }}"
                                        data-e_file="{{ $income->e_file }}"
                                ...
                                @can('delete income')
                                <a href="#deleteRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('admin.income.destroy', $income->e_id) }}"
                                    class="btn btn-danger btn-sm delete-item"><span>Delete</span></a>
                                @endcan

                                @can('approve income')
                                <a href="#approveRecordModal" data-bs-toggle="modal" type="button"
                                data-e_amount="{{ $income->e_amount }}" data-action="{{ route('admin.income.approve', $income->e_id) }}"
                                    class="btn btn-success btn-sm approve-item"><span>Approve</span></a>
                                @endcan

                                @can('reject income')
                                <a href="#rejectRecordModal" data-bs-toggle="modal" type="button" data-action="{{ route('admin.income.reject', $income->e_id) }}"
