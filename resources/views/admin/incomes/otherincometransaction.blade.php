...
<body>
    <div class="watermark">PP OTHER INCOME{{ $pdate }}</div>
 <table width="100%">
<tr>
<td  width="25%">
...
<h1 style="text-align:center">PP OTHER  INCOME REPORT   </h1>
...
<table width="100%">
 ...
 <tr>
 <td>{{ $key + 1 }}</td>
<td>{{ $inboxing->et_name }} </td>
<td>{{ number_format($inboxing->e_amount) }}</td>

@php
$total +=$inboxing->e_amount;
@endphp
<tr>
 @endforeach
<tr>
