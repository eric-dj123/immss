...
@section('page-name')Income @endsection
@section('body')
                                ...
                                <div class="modal-dialog model-lg">
                                    <div class="modal-content">
                                        <div class="modal-header p-3">
                                            <h5 class="modal-title" id="exampleModalLabel">New Other Service Income  Registration</h5>
                ...
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {!! '<span class="badge bg-info">Income Created</span>' !!}
                        @endif
                            </td>
                            {{-- reg date --}}
