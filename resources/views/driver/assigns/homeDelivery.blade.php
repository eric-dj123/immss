            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">
                        @if (Request::routeIs('driver.assigns.homeDelivery'))
                        All Assignments
                        @else
                        Received
                        @endif
            ...
            <div class="card-body">
                <table id="scroll-horizontal" class="table nowrap align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        @if (Request::routeIs('driver.assigns.homeDelivery'))
                        <td>
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#topmodal{{ $delivery->id }}">Approve</button>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body text-center p-5">
                                                ...
                                                <div class="text-muted text-center mx-lg-3">
                                                    <h4 class="">Approve Delivery</h4>

                                                </div>

                                                <div class="mt-2">
                                                    <form action="{{ route('driver.assigns.homeDeliveryApprove',$delivery->id) }}" method="POST">
                                                        @csrf
                                                        @method('PUT')

                                                        <div class="mb-3">
                                                            <label for="example-email-input" class="form-label">Confirm Code </label>
                                                            <input class="form-control numbers" type="text" name="code" placeholder="Enter Confirm Code" id="example-email-input" required>
                        ...
                        @else
                        <td>
                            {{ \Carbon\Carbon::parse($delivery->deliveryDate)->format('d-m-Y') }}
                        </td>
                        @endif
